class Api::V1::AuthController < ApplicationController
    ...
    def create
      ...
      if user && user.authenticate(params[:password])
        ...
        render json: {username: user.username, id: user.id, first_name: user.first_name, last_name: user.last_name, email: user.email, readings: user.readings.map {|reading| reading.cards }, jwt: token}, status: 200
      else
